...
class ProductManager {
  constructor(io, productId) {
    ...
    // Lo inicializo asi porque en mi caso estoy usando subdirectorios por ahora para no hacer npm init en cada uno, no importa.
    this.directoryPath = "../Challenge-9-Segunda-Integracion/data";
